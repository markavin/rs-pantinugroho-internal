                ...
                <div className="space-y-6">
                    ...
                    <div className="flex items-center justify-between mb-4 lg:hidden">
                        ...
                        <select
                            ...
                            className="flex items-center bg-white px-3 md:px-4 py-2 rounded-lg shadow-sm border border-green-300 text-xs md:text-sm text-gray-600 hover:bg-green-300 transition-colors"
                        >
                    ...
                    {/* Search Bar - Show on relevant tabs */}
                    {(activeTab === 'inpatients' || activeTab === 'visitation' || activeTab === 'vitals' || activeTab === 'education') && (
                        <div className="flex items-center space-x-4">
                            <div className="flex-1 mr-1">
                                <div className="relative w-full max-w-xl sm:max-w-2xl md:max-w-7xl">
                                    <input
                                        ...
                                        className="pl-10 md:pl-12 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent w-full text-gray-700 text-sm md:text-base"
                                        value={searchTerm}
                            ...
                            <select
                                value={currentShift}
                                onChange={(e) => setCurrentShift(e.target.value as 'pagi' | 'sore')}
                                className="hidden lg:flex items-center bg-white px-3 md:px-4 py-2 rounded-lg shadow-sm border border-green-300 text-xs md:text-sm text-gray-600 hover:bg-green-300 transition-colors"
                            >
                                <option value="pagi">Shift Pagi</option>
                                <option value="sore">Shift Sore</option>
                            </select>
