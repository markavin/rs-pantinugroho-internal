...
import { Search, Plus, User, Calendar, Activity, TrendingUp, AlertCircle, FileText, Users, HeartPulse, Edit, Trash2, Eye, ActivityIcon } from 'lucide-react';
import {
  mockPatients,
  Patient,
  PatientComplaint,
...
const NursePoliDashboard = () => {
  ...
  const [activeTab, setActiveTab] = useState<'dashboard' | 'patients' | 'complaints' | 'blood-sugar' | 'education'>('patients');
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-3 gap-3 sm:gap-6">
            ...
            <div className="bg-gradient-to-br from-white to-blue-50 p-3 sm:p-6 rounded-xl shadow-sm border border-blue-100 hover:shadow-md transition-shadow">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <div className="mb-2 sm:mb-0">
                  <p className="text-xs sm:text-sm font-medium text-blue-600">Registrasi Hari ini</p>
                  <p className="text-xl sm:text-3xl font-bold text-gray-900 mt-1 sm:mt-2 text-center">{realTimeStats.totalRegistrasi}</p>
                </div>
            ...
            <div className="bg-gradient-to-br from-white to-red-50 p-3 sm:p-6 rounded-xl shadow-sm border border-red-100 hover:shadow-md transition-shadow">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <div className="mb-2 sm:mb-0">
                  <p className="text-xs sm:text-sm font-medium text-red-600">Keluhan Aktif</p>
                  <p className="text-xl sm:text-3xl font-bold text-gray-900 mt-1 sm:mt-2 text-center">{realTimeStats.keluhanAktif}</p>
                </div>
                    ...
                    <div key={patient.id} className="px-6 py-4">
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="flex items-center space-x-4">
                          ...
                          <div className={`px-3 py-1 rounded-full text-sm font-medium ${trend === 'increasing' ? 'bg-red-100 text-red-700' :
