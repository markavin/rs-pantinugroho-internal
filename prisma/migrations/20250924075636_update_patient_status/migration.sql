/*
  ...
  - The values [ACTIVE,RUJUK_BALIK,SELESAI,INACTIVE,FOLLOW_UP] on the enum `PatientStatus` will be removed. If these variants are still used in the database, this will fail.
