    ...
    data: [
      {
        ...
        interactions: ['Glimepiride', 'Insulin', 'Alkohol'],
        contraindications: ['Gagal ginjal berat', 'Ketoasidosis diabetik', 'Gangguan hati berat'],
        sideEffects: ['Mual', 'Diare', 'Nyeri perut', 'Rasa metalik'],
        indications: ['Diabetes melitus tipe 2', 'Sindrom metabolik'],
      },
      {
        ...
        interactions: ['Metformin', 'Aspirin', 'Warfarin'],
        contraindications: ['Diabetes tipe 1', 'Ketoasidosis diabetik', 'Kehamilan'],
        sideEffects: ['Hipoglikemia', 'Pusing', 'Mual', 'Peningkatan berat badan'],
      ...
      },
      {
        ...
        interactions: ['Metformin', 'Glimepiride'],
        contraindications: ['Hipoglikemia', 'Alergi insulin'],
        sideEffects: ['Hipoglikemia', 'Lipodistrofi', 'Reaksi alergi lokal'],
        indications: ['Diabetes melitus tipe 1', 'Diabetes melitus tipe 2 yang tidak terkontrol'],
      }
    ],
  });
